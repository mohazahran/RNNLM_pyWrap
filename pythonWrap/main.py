...
def main(argv):
    ...
    if args.direct_order is not None:
        ...
        if direct_order > rnnlmlib.MAX_NGRAM_ORDER:
            direct_order = rnnlmlib.MAX_NGRAM_ORDER
